...
public class AddAlarmActivity extends AppCompatActivity implements com.wdullaer.materialdatetimepicker.time.TimePickerDialog.OnTimeSetListener
{
    private static final String KEY_RING = "key_ring";
    private Toolbar mToolbar;
    private EditText mTitleText;//标题信息
    private TextView mTimeText, mRepeatText,mWakeText,mRingText;//时间，响铃周期，停止方式，响铃方式
    private FloatingActionButton mFAB1;//悬浮
    private FloatingActionButton mFAB2;
    private Calendar mCalendar;//
    private int  mHour, mMinute,ID;//时间分钟
    ...
    private MediaPlayer player ;//音乐播放
    ...
    private List<Integer> repeatCode = new ArrayList<>();//重复方式
    ...
    //选择时间，利用的是库里面的一个设置时间的框架，直接拿来用了
    public void selectTime(View v){
        Calendar now = Calendar.getInstance();
        com.wdullaer.materialdatetimepicker.time.TimePickerDialog timeDialog = com.wdullaer.materialdatetimepicker.time.TimePickerDialog.newInstance(
    ...
    public void selectRepeat(View v){
        ...
        builder.setIcon(R.drawable.smileblue);
